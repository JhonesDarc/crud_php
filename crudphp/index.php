                ...
                <div class="container">
                    ...
                    <form action="index.php" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" id="email" name="email" value="<?php echo htmlspecialchars($email_edicao); ?>" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <?php else: ?>
                                <button typr="submit">Adicionar pessoa</button>
                            <?php endif; ?>        
                        </div>
                    </form>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if (empty($_SESSION['pessoas'])): ?>
                                <tr>
                                    <td colspan="4">Nenhuma pessoa cadastradas!</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach($_SESSION['pessoas'] as $pessoa): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="index.php?acao=deletar&id=<?php echo $pessoa['id']; ?>" class="delete" onclick="return confirm('Tem certeza que deseja apagar esta pessoa');">Deletar</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>        
